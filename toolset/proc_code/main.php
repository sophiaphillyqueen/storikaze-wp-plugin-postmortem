...
return array (
  "main" => include(dirname(__FILE__)."/f_main.php"),
  "jugo" => include(dirname(__FILE__)."/f_jugo.php"),
  "jugf" => include(dirname(__FILE__)."/f_jugf.php"),
  ...
  "do_f_fardate" => include(dirname(__FILE__)."/f_do_f_fardate.php"),
  "do_social" => include(dirname(__FILE__)."/f_do_social.php"),
)
